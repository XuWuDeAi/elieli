...
public class FanHorListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FanHorListAdapter(Context mContext) {
        this.mContext = (MainActivity) mContext;
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_fanhorlist_v, parent, false);
    ...
    public class RecyclerHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public RecyclerHolder(View itemView) {
            ...
            tv_attributes= itemView.findViewById(R.id.tv_attributes);
            tv_newstatus= itemView.findViewById(R.id.tv_newstatus);
        ...
        public void setData(int position) {
            try {
                ...
                tv_position.setText(""+listdate.getJSONObject(position).getString("postion"));
                tv_attributes.setText(""+listdate.getJSONObject(position).getString("attributes"));
                tv_newstatus.setText(""+listdate.getJSONObject(position).getString("newstatus"));
                Glide.with(mContext)
