...
public class SeaarchDialog extends DialogFragment {
    ...
    private void initListView() {
        ...
        rv_dialog.setAdapter(searchAdapter);
        searchAdapter.setOnItemClickListener(new SearchAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(int position) {
                Intent intent = new Intent(mainActivity, ShowFanActivity.class);
                try {
                    intent.putExtra("id",searchAdapter.listdate.getJSONObject(position).getString("id"));
